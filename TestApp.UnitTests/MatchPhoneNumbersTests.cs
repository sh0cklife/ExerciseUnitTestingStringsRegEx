...
public class MatchPhoneNumbersTests
{
    ...
    {
        // Arrange
        string phoneNumbers = "+359-2 124-5678, +359 2-986 5432, +359-2-555-5";
        string expected = "";
        // Act
        string result = MatchPhoneNumbers.Match(phoneNumbers);
        // Assert
    ...
    {
        // Arrange
        string phoneNumbers = "+359-2-124-5678, +359 2 986 5432, +359-2-555-555, +359-2-123-4134";
        string expected = "+359-2-124-5678, +359 2 986 5432, +359-2-123-4134";
        // Act
        string result = MatchPhoneNumbers.Match(phoneNumbers);
        // Assert
        Assert.That(result, Is.EqualTo(expected));
